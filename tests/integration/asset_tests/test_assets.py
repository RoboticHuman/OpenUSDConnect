    ...
    try:
        ...
        try:
            ...
            wood_network = [
                ...
                {"k": K_SET_CONNECTABLE_INPUT, "prim": "/World/Looks/Wood/Surface",
                 "info_id": "UsdPreviewSurface",
                 "inputs": {"diffuseColor": [0.4, 0.26, 0.13], "metallic": 0.0, "roughness": 0.6},
                 "input_types": {"diffuseColor": "color3f", "metallic": "float", "roughness": "float"}},
            ...
            events = [
                ...
                {"k": K_SET_XFORM_TRS, "prim": "/World/Chair", "fields": ["t"], "t": [0.0, 0.0, 0.0]},
                *wood_network,
