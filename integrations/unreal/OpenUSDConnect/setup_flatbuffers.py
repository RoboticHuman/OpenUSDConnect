...
The flatc-generated bindings staged with the shared native client core pin the
exact runtime version they were produced with (the generated header carries a
static_assert), so the plugin always compiles against this
